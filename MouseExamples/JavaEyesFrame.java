...
public class JavaEyesFrame extends JFrame {
	...
	public JavaEyesFrame() {
		...
		Eye eye1 = new Eye(JavaEyes.DEFAULT_EYEBALL_COLOR,JavaEyes.DEFAULT_EYE_COLOR);
		Eye eye2 = new Eye(JavaEyes.DEFAULT_EYEBALL_COLOR,JavaEyes.DEFAULT_EYE_COLOR);
		Eye eye3 = new Eye(JavaEyes.DEFAULT_EYEBALL_COLOR,JavaEyes.DEFAULT_EYE_COLOR);
		Eye eye4 = new Eye(Color.GREEN, Color.ORANGE);
		...
		for(int x=0; x<99; x++){
			Eye eyex = new Eye(Color.BLUE, Color.GRAY);
			this.addMouseMotionListener(eyex);
			this.add(eyex);
		}
